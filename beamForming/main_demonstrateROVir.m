...
% we will show the original (fully sampled) image, the aliased
% image and the rovir recon (imrovirallvcs_sos).

% the rovir reconstruction will be slightly shifted, that is because the
% roi signal is only shown where it aliased over in the undersampled image.
% 
